...
typedef struct J4AC_android_media_AudioTrack {
    ...
    jmethodID method_getState;
    jmethodID method_getSampleRate;
    jmethodID method_getAudioFormat;
    jmethodID method_getChannelCount;
...
jint J4AC_android_media_AudioTrack__getState(JNIEnv *env, jobject thiz)
{
    return (*env)->CallIntMethod(env, thiz, class_J4AC_android_media_AudioTrack.method_getState);
}

jint J4AC_android_media_AudioTrack__getState__catchAll(JNIEnv *env, jobject thiz)
{
    jint ret_value = J4AC_android_media_AudioTrack__getState(env, thiz);
    if (J4A_ExceptionCheck__catchAll(env)) {
        return 0;
    }
...
jint J4AC_android_media_AudioTrack__getAudioFormat(JNIEnv *env, jobject thiz)
{
    return (*env)->CallIntMethod(env, thiz, class_J4AC_android_media_AudioTrack.method_getAudioFormat);
}
jint J4AC_android_media_AudioTrack__getAudioFormat__catchAll(JNIEnv *env, jobject thiz)
{
    jint ret_value = J4AC_android_media_AudioTrack__getAudioFormat(env, thiz);
    if (J4A_ExceptionCheck__catchAll(env)) {
        return 0;
    }
...
jint J4AC_android_media_AudioTrack__getChannelCount(JNIEnv *env, jobject thiz)
{
    return (*env)->CallIntMethod(env, thiz, class_J4AC_android_media_AudioTrack.method_getChannelCount);
}
jint J4AC_android_media_AudioTrack__getChannelCount__catchAll(JNIEnv *env, jobject thiz)
{
    jint ret_value = J4AC_android_media_AudioTrack__getChannelCount(env, thiz);
    if (J4A_ExceptionCheck__catchAll(env)) {
        return 0;
    }
...
int J4A_loadClass__J4AC_android_media_AudioTrack(JNIEnv *env)
{
    ...
    name     = "getState";
    sign     = "()I";
    class_J4AC_android_media_AudioTrack.method_getState = J4A_GetMethodID__catchAll(env, class_id, name, sign);
    if (class_J4AC_android_media_AudioTrack.method_getState == NULL)
        goto fail;
    ...
    name     = "getAudioFormat";
    sign     = "()I";
    class_J4AC_android_media_AudioTrack.method_getAudioFormat = J4A_GetMethodID__catchAll(env, class_id, name, sign);
    if (class_J4AC_android_media_AudioTrack.method_getAudioFormat == NULL)
        goto fail;

    class_id = class_J4AC_android_media_AudioTrack.id;
    name     = "getChannelCount";
    sign     = "()I";
    class_J4AC_android_media_AudioTrack.method_getChannelCount = J4A_GetMethodID__catchAll(env, class_id, name, sign);
    if (class_J4AC_android_media_AudioTrack.method_getChannelCount == NULL)
        goto fail;
